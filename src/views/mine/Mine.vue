<template>
  <div class="w-screen h-screen bg-[#f4f3f8]">
    ...
    <div class="flex p-2 justify-between fixed top-0 inset-x-0 z-10 bg-white">
      <div>
        <IconPark :icon="ScanCode" theme="filled" size="24" fill="#333" strokeLinejoin="miter" strokeLinecap="square" />
      </div>
      <div class="flex">
        <IconPark :icon="Config" theme="outline" size="24" fill="#333" strokeLinejoin="miter" strokeLinecap="square" />
      </div>
    </div>
    <!-- 个人资料 -->
    <div class="mt-10 common-p py-2">
      <div class="flex items-center my-2">
        <van-image round class="w-[70px] h-[70px]" src="https://fastly.jsdelivr.net/npm/@vant/assets/cat.jpeg" />
    ...
    <div
      ...
      <div class="flex text-[10px] items-center">
        ...
        <div><span class="mr-1 text-sky-400 text-[12px]">60</span>元券包 全场通用</div>
      </div>
